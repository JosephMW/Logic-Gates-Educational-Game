...
* *0.3 hours* Completed [#98 Add the ability to delete individual circuits](https://github.com/JosephMW/Logic-Gates-Educational-Game/issues/98) and merged the matching PR.